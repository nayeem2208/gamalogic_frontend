...
function Header() {
  ...
  return (
    <div
      className="  items-center text-white lg:hidden"
      
    >
      <div className=" px-6 py-4 flex justify-between underlineLi" style={{ backgroundColor: "#0A0E2B" }}>
        {" "}
        <p className="font-semibold text-2xl text-center">GAMALOGIC</p>
        <div>
         {dropDown?<IoCloseSharp onClick={dropDownToggle} className="text-3xl" />:<IoReorderThree className="text-3xl" onClick={dropDownToggle} />}
        </div>
      </div>
      {dropDown&&<div className="pb-10" style={{ backgroundColor: "rgba(10, 14, 43,0.97)" }} >
        <ul className="mb-14 text-lg font-semibold text-left px-8">
          ...
          <li className="py-2 flex underlineLi" onClick={uploadfileDropDownToggle}>
          ...
          <li className="py-2 flex underlineLi" onClick={tutorialDropDownToggle}>
